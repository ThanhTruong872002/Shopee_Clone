    ...
    <div className='bg-[linear-gradient(-180deg,#f53d2d,#f63)] pb-5 pt-2 text-white'>
      <div className='container'>
        <div className='flex justify-end '>
          <Popover
            ...
            renderPopover={
              <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
                <div className='flex flex-col py-2  pr-16 pl-3'>
          ...
          {isAuthenticated && (
            <Popover
              ...
              renderPopover={
                <div className=' rounded-sm border border-gray-200 relative shadow-md bg-white  '>
                  <Link
                    to={path.profile}
                  ...
                  <button
                    ...
                    className='block py-3 px-4 text-left hover:bg-slate-100 bg-white  hover:text-cyan-500 w-full'
                  >
                    Đăng xuất
                  </button>
                </div>
            ...
            >
              <div className='flex items-center py-1 hover:text-gray-300 cursor-pointer ml-6'>
                <div className='w-5 h-5 mr-2 flex-shrink-0'>
                  <img
                    src='	https://down-vn.img.susercontent.com/file/e3102f0e3c4a9b1420758e50504934a6_tn'
                    alt='avatar'
        ...
        <div className='grid grid-cols-12 gap-4 mt-4'>
          ...
          <div className='cols-span-1 mt-2 ml-6 justify-self-end'>
            <Popover
                      ...
                      <div className='mt-5'>
                        <div className='mt-4 flex'>
                          <div className='flex-shrink-0'>
                            <img
                              src='https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-ln8493kaep5k30_tn'
                              alt='anh'
                          ...
                          <div className='flex-grow ml-2 overflow-hidden'>
                            <div className='truncate'>
                              Giày asics court mz đủ màu mới nhất, Giày Thể Thao asics bản like.au full size nam nữ
                            </div>
                          </div>
